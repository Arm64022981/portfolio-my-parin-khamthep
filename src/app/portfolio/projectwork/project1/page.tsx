...
const TECHNOLOGIES = [
    ...
    { name: 'WebSockets', icon: Wifi, color: 'from-indigo-500 to-blue-500' },
];
...
const WORKFLOW_STEPS = [
    ...
    },
    {
        ...
        desc: 'The doctor diagnoses the patient’s condition and records the treatment information.',
        icon: MessageSquare,
    },
];
...
const HeroSection = () => (
    <motion.div variants={itemVariants} className="text-center mb-20">
        ...
        >
            ...
            <br />
            <span className="text-white">Medical System</span>
        </motion.h1>
        <motion.p
            variants={itemVariants}
            className="text-xl text-white leading-relaxed max-w-3xl mx-auto font-light"
        >
            Revolutionizing healthcare communication through real-time AI-powered sign language translation,
            bridging the gap between doctors and hearing-impaired patients.
        </motion.p>
    </motion.div>
);
    ...
    <Section className="mb-24">
        ...
        >
            ...
            <p className="text-center text-white mt-6 max-w-3xl mx-auto leading-relaxed">
                This diagram shows the system workflow starting with the acquisition of sign language input through a camera, followed by data processing and analysis, then recording the processed data into the database, and finally applying the stored information to assist in medical diagnosis
            </p>
        </motion.div>
    </Section>
);
